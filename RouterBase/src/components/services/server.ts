// import { createServer, Model,Registry,Server,ModelInstance,hasMany } from "miragejs"
...
// // type AppRegistry = Registry<{ vans: ModelInstance<vanModel>  } ,{ /* factories can be defined here */ }>
// type AppSchema =Schema<Registry<vanModel,{} >>
...
//         this.get("/vens", (schema:AppSchema) => {
//             return schema.all("vans")
//         })
        
//         this.get("/vens/:id", (schema:AppSchema, request) => {
